...
if __name__ == "__main__":
    ...
    #观看训练时间曲线
    his_PDDQN = np.vstack((episodes, steps))

    file = open('his_PDDQN.pickle', 'wb')
    pickle.dump(his_PDDQN, file)
    file.close()

    plt.plot(his_PDDQN[0, :], his_PDDQN[1, :] - his_PDDQN[1, 0], c='b', label='Prioritized DDQN')
