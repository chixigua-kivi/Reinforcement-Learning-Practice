...
if __name__ == "__main__":
    ...
    #观看训练时间曲线
    his_rainbow_DQN = np.vstack((episodes, steps))

    file = open('his_rainbow_DQN.pickle', 'wb')
    pickle.dump(his_rainbow_DQN, file)
    file.close()

    plt.plot(his_rainbow_DQN[0, :], his_rainbow_DQN[1, :] - his_rainbow_DQN[1, 0], c='b', label='Rainbow DQN')
